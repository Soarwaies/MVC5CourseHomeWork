namespace MVC5CourseHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶概要檢視Repository Get客戶概要檢視Repository()
		{
			var repository = new 客戶概要檢視Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶概要檢視Repository Get客戶概要檢視Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶概要檢視Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
